                ...
                <div className=" top-40 bg-white shadow rounded py-12 lg:px-28 px-8">
                    ...
                    <div className="md:flex items-center mt-8">
                        <div className="md:w-72 flex flex-col">
                            ...
                            <input tabIndex={0} aria-role="input" arial-label="Please input company name" type="name" className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 " placeholder="Please input company name" />
                        </div>
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                    ...
                    <div>
                        <div className="w-full flex flex-col mt-8">
                            ...
                            <textarea tabIndex={0} aria-label="leave a message" aria-role="textbox" type="name" className="h-36 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none" defaultValue={""} />
                        </div>
                    </div>
